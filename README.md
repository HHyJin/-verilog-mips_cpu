...
###### 3.  연산 간 overflow를 체크 하는 회로를 구성한다.  A가 양수인 경우 A<B이려면 sub_overflow가 나야 한다. A가 음수인 경우 A<B이려면 sub_overflow가 나지 않아야 한다. 
	always @(*) 
	begin
		case (ALUOp)
...
### 17. testbench.v 
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTQ0ODE4NjM0OCwtODMyOTkyMjY3LDE4MT
