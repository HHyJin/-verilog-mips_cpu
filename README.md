...
###### 3.  연산 간 overflow를 체크 하는 회로를 구성한다.  A가 양수인 경우 overflow가 나면 A<B이다. A가 음수인 경우 overflow가 안나면 A<B이다.  즉 A가 양수의 경우 sub_overflw시 slt를 1로 
	always @(*) 
	begin
		case (ALUOp)
...
### 17. testbench.v 
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTg1MzU2MjQwLDE0NDgxODYzNDgsLTgzMj
