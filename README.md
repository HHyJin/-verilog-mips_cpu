...
###### 3.  연산 간 overflow를 체크 하는 회로를 구성한다.  sub_overflow시 양수끼리 연산의 경우 msb bit가 바뀐다 = (a<b).  즉 slt는 msb의 반대부호로 set되면 된다. 단 음수끼리 연산의 경우 반대로 a>b일 경우 msb bit가 바뀐다. 이때는 
	always @(*) 
	begin
		case (ALUOp)
...
### 17. testbench.v 
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE4MDM1NzQ2NDYsLTgzMjk5MjI2NywxOD
EzNDQ5MjEsLTE1NDMzMjY2NTAsNTU3NzQzOTUwLDEzNTcwMjcw
NjMsNTcwNDQ4MDc1LDY0MTkyNzkzOCwtMjA0NzA1MjYyN119
-->